...
if ( ! empty( $param['background_img_checkbox'] ) ) {
	$script['popup_css']['background-color'] = $param['background'];
...
switch ( $param['location'] ) {
	...
	case '-topRight':
		...
		$script['popup_css']['top']   = $param['top'] . $top_unit;
		$script['popup_css']['right'] = $param['right'] . $right_unit;
		break;
	case '-bottomRight':
		$bottom_unit                   = isset( $param['bottom_unit'] ) ? $param['bottom_unit'] : 'px';
		$right_unit                    = isset( $param['right_unit'] ) ? $param['right_unit'] : 'px';
