...
class GeneralInspector extends Component {
    ...
    render() {
        const { blockTitle, blockTitleLayout, blockTitleAlign, sliderpostCategory, sliderpostCount, slidercontentOption, slidercontentType, sliderwordCount, sliderbuttonOption, sliderbuttonLabel, sliderorderBy, sliderorder, sliderdateOption, sliderauthorOption, slidercategoryOption, slidercategoriesCount, slidertagsOption, slidertagsCount, slidercommentOption, permalinkTarget, carouselType, carouselAuto, carouselDots, carouselControls, carouselLoop, carouselSpeed, fallbackImage } = this.props.attributes;
